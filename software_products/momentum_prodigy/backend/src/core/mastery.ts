...
/** Default lesson mastery requirement; README documents this as 90%. */
export const MASTERY_THRESHOLD = 0.9;
/** Default review-readiness requirement; README documents this as 80%. */
...
/** Averages card mastery across a lesson. */
...
/** Measures how much of a lesson has graduated into long-term review. */
...
/** Determines whether a lesson satisfies both the mastery and readiness gates. */
...
/** Ranks concepts by low accuracy or repeated lapses so practice can focus on weak spots. */
