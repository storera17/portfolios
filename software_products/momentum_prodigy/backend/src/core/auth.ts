...
/** Configuration or lookup table for ITERATIONS; keeping it named makes future tuning safer. */
const ITERATIONS = 120_000;

/** Encodes binary crypto data into a storage-safe base64 string. */
...
/** Decodes stored base64 crypto data back into bytes for WebAuthn/WebCrypto. */
...
/** Creates cryptographically strong random bytes for password salts and challenges. */
...
/** Derives the password hash with PBKDF2 so the raw password is never stored. */
...
/** Creates the first local profile after validating username and password. */
...
/** Checks a password by deriving a new hash and comparing it with the stored hash. */
...
/** Detects whether this runtime exposes platform biometric/WebAuthn authentication. */
