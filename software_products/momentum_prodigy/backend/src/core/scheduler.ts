...
/** Scheduler constants; tune these carefully because they change the learner pacing model. */
export const SCHED = {
...
/** Milliseconds in one minute, used to keep scheduling calculations readable. */
const MIN = 60_000;
/** Milliseconds in one day, used for review intervals. */
const DAY = 86_400_000;

/** Creates the first scheduling record for a card before the learner has reviewed it. */
...
/** Converts a timestamp into a YYYY-MM-DD key for streaks and daily pacing. */
...
/** Moves a learning/relearning card into long-term review. */
...
/** Checks whether a card is ready to appear in today’s review queue. */
...
/** Separates queue buckets so the UI can explain learning, review, and new-card workload. */
...
export function buildQueue(
  ...
  /** Performs the for operation for this class. */
