...
/** Small deterministic hash used for embeddings and card visual identity. */
...
/** Converts text into a normalized hashed-feature vector for offline semantic search. */
