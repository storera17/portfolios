...
/** Enables or disables all synthesized UI audio from settings. */
export function setMuted(m: boolean) { muted = m; }

/** Lazily creates the WebAudio context only when sound is actually needed. */
...
/** Plays one short synthesized tone; larger sound effects compose several tones. */
...
/** Named sound-effect palette used by UI events without shipping audio files. */
export const sfx = {
