...
/** Configuration or lookup table for FALLBACK_CONTEXT; keeping it named makes future tuning safer. */
const FALLBACK_CONTEXT = {
  domain: 'analytics', overview: 'A core analytics topic.', why: '',
  workplace: '', mistakes: [], sources: [],
};

/** Finds the domain context that should guide lesson synthesis for a subdeck. */
...
/** Removes special marker characters from generated instructional text. */
export const strip = (s) => String(s ?? '').replace(/[«»]/g, '');

/** Chooses high-signal related terms for a mini-lesson. */
