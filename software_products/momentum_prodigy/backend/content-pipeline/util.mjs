...
/** Configuration or lookup table for TYPO_FIXES; keeping it named makes future tuning safer. */
const TYPO_FIXES = [
...
/** Creates short URL/file/id-safe strings from human-readable labels. */
...
/** Formats generated labels in title case. */
